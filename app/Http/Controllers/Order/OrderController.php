    ...
    public function cancelOrder(Request $request)
{
    ...
    // 🔓 Liberar la mesa SOLO si es orden de mesa
    if ($order->table_id) {
        TableHelper::markTableAsPaid($order->table_id);
    }
...
public function KOTPartial()
{
    ...
    return view('orders.partials.kot-orders', compact(
        'tables',
        'orders',
        'tableOrders',
        'takeawayOrders',
...
{
    \Log::info("getStatus called for order ID: " . $id);

    $order = Order::findOrFail($id);
\Log::info("Estado de la orden antes de emitir el evento: " . $order->status->value);
